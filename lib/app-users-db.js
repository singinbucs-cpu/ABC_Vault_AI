  ...
  const result = await getPool().query(
    `
      ...
      SET
        ...
        notify_vault_open = $9,
        notify_vault_closed = $10,
        notifications_critical = $11,
        critical_initial_load = $12,
        critical_added = $13,
        critical_changed = $14,
        critical_removed = $15,
        critical_purchasable = $16,
        critical_vault_open = $17,
        critical_vault_closed = $18,
        vault_key_auto_import_enabled = $19,
        vault_key_forwarding_email = $20,
        updated_at = NOW()
      WHERE email = $1
      RETURNING
        id,
